      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            />
            {/* BIOGRAPHY TITLE */}
            <h1 className="font-bold text-2xl">Personal Interests</h1>
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
            My main objective would be to develop my skills in collaborative 
            real world problem solving and their practical application through
             integration of latest technology and software. While doing so I 
             would look forward to better understanding the organizational framework 
             of big corporates and team building. I am eager to be together with people 
             pursuing similar organizational goals and learning from the experience as 
             well as intellect of the hierarchy.
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
            ideas that work are great ideas and the ones that do not are good ideas. There are no bad ideas.
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
